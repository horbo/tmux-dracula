...
builtin_map="zsh|bash|fish|sh|dash=󰆍 nvim= vim|vi= claude=󰚩 codex= agy=󰊭 lazygit|git|tig=󰊢 ssh|mosh=󰣀 docker|lazydocker=󰡨 python|python3|ipython= node|bun|deno=󰎙 htop|btop|top=󰍛 kubectl|k9s=󱃾 cargo= go= make=󰒓 brew= man|less|bat=󰈙"
